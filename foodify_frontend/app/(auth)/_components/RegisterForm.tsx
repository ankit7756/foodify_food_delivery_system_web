...
// //                     id="name"
// //                     placeholder="Ankit Sharma"
// //                     className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 bg-background"
// //                 />
// //                 {errors.name && <p className="text-sm text-red-600">{errors.name.message}</p>}
// //             </div>
...
// //                 type="submit"
// //                 disabled={isLoading}
// //                 className="w-full py-3 bg-gradient-to-r from-orange-500 to-pink-600 text-white rounded-lg font-semibold disabled:opacity-60 hover:from-orange-600 hover:to-pink-700 transition-all shadow-md"
// //             >
...
//                 type="submit"
//                 disabled={isLoading}
//                 className="w-full py-3.5 bg-gradient-to-r from-orange-500 to-pink-600 text-white rounded-lg font-semibold disabled:opacity-60 disabled:cursor-not-allowed hover:from-orange-600 hover:to-pink-700 hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-md mt-6"
//             >
//                 {isLoading ? (
//                     <>
